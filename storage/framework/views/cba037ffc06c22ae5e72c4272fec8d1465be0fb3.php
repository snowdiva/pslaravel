...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="../../index2.html" class="logo">
            ...
            <span class="logo-mini"><b>Ps</b>后台</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>Pinshu</b>管理后台</span>
        </a>
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="adminstyle/img/user2-160x160.jpg" class="user-image" alt="User Image">
                            <span class="hidden-xs"><?php echo e($username); ?></span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="adminstyle/img/user2-160x160.jpg" class="img-circle" alt="User Image">

                                <p>
                                    <?php echo e($username); ?> - 超级管理员
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="adminstyle/img/user2-160x160.jpg" class="img-circle" alt="<?php echo e($username); ?>">
                </div>
            ...
            <form action="#" method="get" class="sidebar-form">
                <div class="input-group">
                    <input type="text" name="q" class="form-control" placeholder="搜索用户...">
...
<script src="adminstyle/js/app.min.js"></script>
